      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-sm">
            ...
            />
            <div className="p-6">
              <p className="text-[#b99d74] text-xs font-medium tracking-wider mb-2">
                TRAITEUR
              </p>
              <h3 className="text-[#2c3639] text-xl font-semibold mb-3">
                Pour les écoles
              </h3>
              <p className="text-[#697077] text-sm mb-6 leading-relaxed">
                Des repas équilibrés et savoureux adaptés aux besoins des
                élèves, préparés avec des ingrédients frais et de qualité.
              </p>
              <button className="bg-[#d3b486] hover:bg-[#b99d74] text-white px-6 py-2 rounded cursor-pointer">
                Commander
              </button>
            </div>
          </div>
      ...
      <section className="w-full py-16 px-4 ">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h2 className="[font-family:'Great_Vibes',Helvetica] font-normal text-[#2c3639] text-base tracking-[4.80px]">
              About Us
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="space-y-6">
              {/* Badge */}
              <div className="bg-[#d3b486] text-white hover:bg-[#b99d74] px-6 py-2 rounded-full [font-family:'Plus_Jakarta_Sans',Helvetica] font-bold text-[17px] inline-block">
                Des repas qui marquent vos plus beaux souvenirs
              </div>

              {/* Description */}
              <div className="[font-family:'Plus_Jakarta_Sans',Helvetica] font-normal text-[#697077] text-xl leading-[35px]">
